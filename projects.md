...
## EasyGANTT
Leverage [Excel](https://github.com/pgaljan/EasyGantt) or [Google Sheets](https://docs.google.com/spreadsheets/d/1P6RNkddPKZdURB0l4eMhgWIVk0Iv4WlQ97G0zSBvkOw/edit?usp=sharingl) to generate PlantUML GANTT markup.  EasyGANTT has robust features such as zoom to time period, configurable frontmatter, auto progress indication, with mutliple timebox options.
![alt text](./images/easygantt.png)

## Mockup as Code
Use PlantUML and an easily navigated [library](https://github.com/pgaljan/dac/blob/main/salt.md) of UI artifaces to generate accurate, iterable mockups as code.
![](./images/ec2_dash-puml.png)
